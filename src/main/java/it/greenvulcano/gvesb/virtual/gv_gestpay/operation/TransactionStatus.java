...
import it.greenvulcano.gestpay.wss2s.model.CallReadTrxS2S;
import it.greenvulcano.gestpay.wss2s.model.CallReadTrxS2SResponse.CallReadTrxS2SResult;
...
public class TransactionStatus {
	...
	public TransactionStatus() {
		logger.info("Created Transaction Status Operation");
	}
	 ...
	 * @return
	 */
	public String transactionStatusService(String data, WSs2S wss2s) {
		...
		try {
			...
			CallReadTrxS2S transactionStatus = mapper.readValue(data, CallReadTrxS2S.class);
			
			WSs2SSoap wsS2sSoap = wss2s.getWSs2SSoap();
			
			CallReadTrxS2SResult result = wsS2sSoap.callReadTrxS2S(
					transactionStatus.getShopLogin(), 
					transactionStatus.getShopTransactionId(), 
					transactionStatus.getBankTransactionId());
